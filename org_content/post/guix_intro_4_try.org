...
#+TITLE: Guix Introduction Part 3: Try Guix
...
out. Next time we show a little demo of managing per-project
dependency with Guix, through the =guix time-machine= and =guix
